...
> 由 `/design-machine wafer` 依 `docs/machines/wafer.md` 產出。確認後由 `/add-component` 實作。
- type: machine
- 研究來源: docs/machines/wafer.md
- 機台級流機制: 見 `docs/plan/semiconductor-machine-redo.md` Phase 0(Part.process + ProcessSpec.scale)
