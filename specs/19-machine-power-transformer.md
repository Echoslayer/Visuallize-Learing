...
> 由 `/design-machine power-transformer` 依 `docs/machines/power-transformer.md` 產出。確認後由 `/add-component` 實作。
- type: machine
- 研究來源: docs/machines/power-transformer.md
- 對應 topic: `grid`
...
採 `docs/plan/machine-patterns.md` 的 **Transformer** pattern,但補足 Phase B 需要的細節:
