...
```
Phase A  研究供應鏈   /research-supply-chain wind      → docs/supply-chains/wind.md
Phase B  設計 demo    /design-demo wind                → specs/<NN>-topic-wind.md
...
- [ ] `/research-supply-chain wind` → `docs/supply-chains/wind.md`。
...
- [ ] `/design-demo wind` → `specs/<NN>-topic-wind.md`。
- [ ] **scope 拍板**:
  - [ ] A close-up:單台風機拆細。
...
- [ ] Phase A 研究供應鏈(`docs/supply-chains/wind.md`)
- [ ] Phase B 設計 demo(`specs/<NN>-topic-wind.md` + scope/能量流拍板)
