...
> 由 `/design-machine distribution-load` 依 `docs/research/machines/distribution-load.md` 產出。確認後由 `/add-component` 實作。
- type: machine
- 研究來源: docs/research/machines/distribution-load.md
- 對應 topic: `grid`
