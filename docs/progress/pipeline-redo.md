...
```
Phase A  研究供應鏈   /research-supply-chain pipeline  → docs/research/supply-chains/pipeline.md
Phase B  設計 demo    /design-demo pipeline            → docs/specs/<NN>-topic-pipeline.md
...
- [ ] `/research-supply-chain pipeline` → `docs/research/supply-chains/pipeline.md`。
...
- [ ] `/design-demo pipeline` → `docs/specs/<NN>-topic-pipeline.md`。
- [ ] **scope 拍板**:
