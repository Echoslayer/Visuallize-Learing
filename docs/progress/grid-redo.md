...
```
Phase A  研究供應鏈   /research-supply-chain grid      → docs/research/supply-chains/grid.md
Phase B  設計 demo    /design-demo grid                → docs/specs/<NN>-topic-grid.md
...
- [ ] `/research-supply-chain grid` → `docs/research/supply-chains/grid.md`。
...
- [ ] `/design-demo grid` → `docs/specs/<NN>-topic-grid.md`。
- [ ] **scope 拍板**:
  - [ ] A close-up:單台變壓器拆細。
...
- [x] Phase A 研究供應鏈(`docs/research/supply-chains/grid.md`)
- [x] Phase B 設計 demo(`docs/specs/18-topic-grid.md` + scope/電力流拍板)
