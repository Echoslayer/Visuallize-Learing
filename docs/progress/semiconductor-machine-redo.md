...
[`../machines/README.md`](../research/machines/README.md)。本檔只列「這次重做」的步驟與 checklist,不複製上述內容。
...
### 每台的 checklist
- [ ] **Research** — `/research-machine <機台>` → `docs/research/machines/<slug>.md`。事實查證,代號/供應商標「需查證」交人類核。
- [ ] **Design** — `/design-machine <slug>` → `docs/specs/<NN>-machine-<slug>.md`。
