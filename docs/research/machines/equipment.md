...
| 公司 | 代號 | 角色 | 備註 |
|---|---|---|---|
| ASML | ASML NL | 微影設備(EUV 獨家) | 已查證 |
| Applied Materials | AMAT US | 沉積/蝕刻/CMP 設備 | 已查證 |
| Lam Research | LRCX US | 蝕刻/沉積設備 | 已查證 |
| Tokyo Electron TEL | 8035 JP | 塗佈/蝕刻設備 | 已查證 |
| KLA | KLAC US | 量測/檢測設備 | 已查證 |
| 家登精密 GUDENG | 3680 TW | EUV 光罩盒/載具 | 已查證 |
| 京鼎精密 | 3413 TW | 半導體設備代工 | 已查證 |
| 中砂 Kinik | 1560 TW | CMP 鑽石碟/研磨 | 已查證 |
| 崇越 Topco | 5434 TW | 半導體材料通路 | 已查證 |
| 信越 / JSR / TOK | — | 光阻 / 材料 | 已查證 |
| Linde / Air Liquide | — | 特殊氣體 | 已查證 |
