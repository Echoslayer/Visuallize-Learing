...
| 公司 | 代號 | 角色 | 備註 |
|---|---|---|---|
| 日月光投控 ASE | 3711 TW | 封裝測試(全球龍頭) | 已查證 |
| 力成 PTI | 6239 TW | 封裝測試/記憶體封測 | 已查證 |
| 京元電 KYEC | 2449 TW | 半導體測試 | 已查證 |
| 南茂 ChipMOS | 8150 TW | 封裝測試 | 已查證 |
| 頎邦 Chipbond | 6147 TW | 驅動 IC 封測(COF) | 已查證 |
| 精材 XinTec | 3374 TW | 晶圓級封裝 WLCSP | 已查證 |
| Amkor | AMKR US | 封裝測試 | 已查證 |
| 通富微電 / JCET | — CN | 封裝測試 | 已查證 |
